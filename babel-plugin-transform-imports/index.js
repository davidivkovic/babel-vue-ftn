      ...
      ImportDeclaration: function (path, state) {
        ...
        if (hasOpts) {
          ...
          memberImports.forEach(function (memberImport) {
            ...
            (sources[replace] ||= []).push(newImportSpecifier)
          ...
          const transforms = Object.entries(sources).map(([replacement, specifiers]) => (
            types.importDeclaration(specifiers, types.stringLiteral(replacement))
          ))
